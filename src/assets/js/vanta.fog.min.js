...
! function (e, t) {
  ...
  return function (e) {
    ...
    const a = e => document.querySelector(e),
      u = e => "number" == typeof e ? "#" + ("00000" + e.toString(16)).slice(-6) : e,
      c = (e, t = 1) => {
        const i = u(e),
    ...
    r.register = (e, t) => r[e] = e => new t(e), r.version = "0.5.21";
    const h = function () {
    ...
    r.VantaBase = class {
      constructor(e = {}) {
        ...
        if (this.options = Object(o.c)({
            ...
            el: e
          }), Object(o.c)(this.options, e), this.options.THREE && (s = this.options.THREE), this.el = this.options.el, null == this.el) h('Instance needs "el" param!');
        else if (!(this.options.el instanceof HTMLElement)) {
          const e = this.el;
          if (this.el = Object(o.f)(e), !this.el) return void h("Cannot find element", e)
        }
